...
<h2>Introduction</h2>
<p>
   <i>Desktop Clock</i> is a product provided by <i>JulyApp</i> (hereinafter referred to as "we").
   When you use our services, we may collect and use your relevant information. We hope to explain to you through this "Privacy Policy" how we collect, use, store and share this information when using our services, and how we provide you with access, update, control and protection of this information.
   This "Privacy Policy" is closely related to the <i>Desktop Clock</i> service you use. I hope you read it carefully and make the choices you deem appropriate according to the guidelines of this "Privacy Policy" when necessary. For the relevant technical terms involved in this "Privacy Policy", we try to use concise and concise expressions and provide links to further explanations for your understanding.
</p>
<p><strong>By using or continuing to use our services, you agree to our collection, use, storage and sharing of your relevant information in accordance with this Privacy Policy. </strong></p>
<p>If you have any questions about this Privacy Policy or related matters, please contact us at <a href="mailto:julyiappdev@gmail.com"><strong>julyiappdev@gmail.com</strong></a>. </p>


<h2>1. Information we collect</h2>
<p>When we or our third-party partners provide services, we may collect, store and use the following information about you. If you do not provide relevant information, you may not be able to register as our user or enjoy some of the services we provide, or you may not be able to achieve the intended effect of the relevant services. </p>

<ul>
   <li><strong>Log information</strong> refers to the information that the system may collect through cookies, identifiers and related technologies when you use our services, including your <strong>device information</strong>, <strong>browsing information</strong>, <strong>click information</strong>, and store such information as log information to provide you with a personalized user experience and ensure service security. You can refuse or manage the use of cookies, identifiers or related technologies through your browser settings. </li>
</ul>
...
<strong>2.1 Method and period of information storage</strong>
<ul>
<li>We will store your information in a secure manner, including local storage (such as using APP for data caching), database and server logs. </li>
<li>Generally, we will only store your personal information for the time necessary to achieve the service purpose or under the conditions stipulated by laws and regulations. </li>
</ul>

<strong>2.2 Region of information storage</strong>
<ul>
<li>We will store user personal information collected in China in Firebase in accordance with laws and regulations. </li>
<li>We do not currently transfer or store your personal information across borders. If cross-border transmission or storage is required in the future, we will inform you of the purpose, receiver, security assurance measures and security risks of the information outbound, and obtain your consent. </li>
</ul>

<strong>2.3 Notice when the product or service ceases to operate</strong>
<ul>
<li>When our products or services cease to operate, we will notify you with push notifications, announcements, etc., and delete or anonymize your personal information within a reasonable period of time, unless otherwise stipulated by laws and regulations. </li>
</ul>
...
<ul>
   ...
   <li>When we provide services, it is used for identity verification, customer service, security protection, fraud detection, archiving and backup purposes to ensure the security of the products and services we provide to you;</li>
   <li>Help us design new services and improve our existing services;</li>
   <li>To enable us to better understand how you access and use our services, so as to respond to your individual needs in a targeted manner, such as language settings, location settings, personalized help services and instructions, or respond to you and other users in other ways;</li>
   <li>To provide you with advertisements that are more relevant to you instead of advertisements that are generally served;</li>
   <li>Evaluate and improve the effectiveness of advertisements and other promotions and promotions on our Services;</li>
   <li>Software certification or management of software upgrades;</li>
   <li>Enabling you to participate in surveys about our products and services. </li>
</ul>

<h2>5. Information sharing</h2>
<p>
At present, we will not actively share or transfer your personal information to third parties. If there are other situations where your personal information is shared or transferred or you need us to share or transfer your personal information to a third party, we will directly or confirm that the third party obtains your express consent to the above behavior.
</p>
<p>
In order to place advertisements, evaluate and optimize the effect of advertisements, we need to share some of your data with third-party partners such as advertisers and their agents, and require them to strictly abide by our measures and requirements on data privacy protection, including but not limited to processing in accordance with data protection agreements, commitment letters and relevant data processing policies, to avoid identification of personal identities, and to protect privacy and security.
</p>
<p>
